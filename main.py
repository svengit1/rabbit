...
grape = Fruit(space=space, type=Fruit.GRAPE, points=10, hpos=9, vpos=19, batch=world_batch, group=background)
lemon = Fruit(space=space, type=Fruit.LEMON, points=20, hpos=13, vpos=20, batch=world_batch, group=background)
carrot = Fruit(space=space, type=Fruit.CARROT, points=30, hpos=15, vpos=19, batch=world_batch, group=background)
moving_platform3 = MovingPlatform(space=space, width=20, initial_position=(35, 10), velocity=(150, 19),
                                  path_length=500,
                                  batch=world_batch, group=background)
